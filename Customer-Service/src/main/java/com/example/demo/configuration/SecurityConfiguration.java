...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter 
{
	...
	{
		http.cors().disable();
	http.csrf().disable().authorizeRequests().antMatchers("/subs","/auth","/v2/api-docs","/customer/categories","/customer/coupon",
	"/configuration/ui",
	"/swagger-resources/**",
	...
	private ApiKey apiKey() {
		...
		"1.0",
		"Terms of service",
		new Contact("Lakshmi", "www.grabon.com", "lakshmi5@gmail.com"),
		"License of API",
		"API license URL",
